/*
 * SHT31 Temperature & Humidity Sensor Library
 * ============================================
 * 
 * PURPOSE:
 * Library for reading temperature and humidity data from SHT31 sensor via I2C.
 * Provides functions for sensor initialization, data reading, and status monitoring.
 * 
 * ENVIRONMENT:
 * - Hardware: ESP32 with SHT31 sensor
 * - Platform: PlatformIO with Arduino framework
 * - Libraries: Wire (I2C), Adafruit_SHT31
 * 
 * FUNCTIONALITY:
 * 1. Initializes I2C communication with SHT31 sensor
 * 2. Reads temperature and humidity data every 5 seconds
 * 3. Provides status indicators for temperature and humidity ranges
 * 4. Includes safety checks and error handling
 * 5. Offers utility functions for data access and status monitoring
 * 6. Serial debug output with emoji indicators
 * 
 * CONNECTIONS:
 ...
 * 
 * USAGE:
 * Include this library in sensor projects that need temperature and humidity data.
 * Call initSHT31() in setup() and updateSHT31() in loop().
 */
